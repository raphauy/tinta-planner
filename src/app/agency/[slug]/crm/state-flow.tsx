    ...
    <section className="flex w-full">
        ...
        <div className="w-full">
            <div className="relative flex items-center justify-center h-12 p-4 text-white bg-blue-500">
                ...
                <svg 
                    className="absolute top-0 bottom-0 right-0 h-full text-blue-500 bg-white fill-current" 
        ...
        <div className="relative flex items-center justify-center h-12 p-4 mb-4 text-white bg-blue-500">
            <svg 
            className="absolute top-0 bottom-0 left-0 h-full text-white bg-blue-500 fill-current" 
            xmlns="http://www.w3.org/2000/svg" 
            viewBox="0 0 6 20">
                <polygon points="0,0 3,10 0,20"/>
            </svg>
        ...
        <div className="w-full">
            <div className="flex w-full">
                ...
                <div className="w-6 h-6 p-4 mt-2 mr-1 bg-green-500 rounded-full"></div>
            </div>
