...
export const columns: ColumnDef<DataWine>[] = [
  ...
  },
  {
    ...
    cell: ({ row }) => {
      const wine = row.original     
      return (
        <Link href={`/agency/${wine.clientSlug}/social/wines/edit?wineId=${wine.id}`} className="flex items-center">
      ...
      return (
        <DropdownMenu>
          ...
          <DropdownMenuContent align="end">
            ...
            <DropdownMenuItem>
                <Link href={`/agency/${wine.clientSlug}/social/wines/delete?wineId=${wine.id}`} className="flex items-center">
