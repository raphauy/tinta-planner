...
import { roles } from "@/app/agency/[slug]/social/users/columns"
...
export function DataTable<TData, TValue>({ columns, data, columnsOff, pageSize, roles }: DataTableProps<TData, TValue>) {
